...
%cite: https://github.com/pubkey/rxdb
...
%cite: https://pouchDB.com/learn.html
...
It is schema-free.
%cite: https://cwiki.apache.org/confluence/display/COUCHDB/Introduction
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=15cm]{offline-first.png}
    \end{center}
...
%cite: https://hasura.io/blog/design-guide-to-offline-first-apps/#conflicts
...
%cite: https://rxdb.info/replication-graphql.html
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=15cm]{cap.png}
    \end{center}
...
%cite: https://guide.couchdb.org/draft/consistency.html
