...
Hosting static assets is cheap and now your page is being served at the same rate.
...
Your static HTML, CSS, and JS are maintained for you headache-free.

\subsubsection{Security}

With JAMstack, there is no need to lockdown all the services as a central organisation, instead, 
we can lock separate containerised services.
